          ...
          isLoading? <span className="loading loading-spinner loading-lg "></span>:null
            ...
            <div  className="grid grid-cols-1 lg:grid-cols-3 gap-3">
            {
                ...
                <figure className="relative" >
                  <Link to={`/subCa/${category.subcategory_name}`}><img src={category.image} alt="" className=" hover:border-red-500 hover:border-4 rounded-xl h-[200px] w-[300px] border-2 border-[#eb9b40]" /></Link>
